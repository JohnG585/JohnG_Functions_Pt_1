...
function somethingFunny() {
  document.getElementById("q1").innerHTML="There's only one thing you can do when you're this good at coding:"+

  "<p>"+"Strut."+"</p>"
  document.getElementById("bart").classList.add("show")
};
somethingFunny();
...
document.getElementById("submit").addEventListener("click", function() {
    document.getElementById("q2").innerHTML=divideByTwo(document.getElementById("divideNum").value);
});
...
function greeting(name1, name2) {
   return "Hey " + name1 + " and " + name2 + ", how are you?";
};
document.getElementById("nameSubmit").addEventListener("click", function() {
    document.getElementById("q3").innerHTML = greeting(name1.value, name2.value);
  });
...
function aveNum(a,b,c,d,e,f) {
  return (a+b+c+d+e+f)/6;
};
  document.getElementById("q4").innerHTML="The average of the numbers 9, 10, 5, 7, 12, and 6 is "+aveNum(9,10,5,7,12,6)+".";
...
function total(price, unit){
  return (price * unit);
}
document.getElementById("q5").innerHTML="Your price for the cashews this month should be $" + total(9.99, 12) + ".";
...
document.getElementById("q6a").innerHTML="The area of the rectangle is "+area(4,7)+" inches.";
document.getElementById("q6b").innerHTML="The perimeter of the rectangle is "+perimeter(4,7)+" inches.";
...
document.getElementById("q7").innerHTML="One fourth of 40 is "+quarter(40)+".";
...
function sleepings(hours) {
  if (hours >= 8) {
    document.getElementById("q8").innerHTML="You got the proper amount of sleep! You go girl!"
  }
  else {
    document.getElementById("q8").innerHTML="Go get some sleep"
  };
}
sleepings(9);
...
document.getElementById("q9").innerHTML="You're most likely "+userAge(1985)+" years old.";
...
var purpleMonkeys = [];
var blueBarracudas = [];
function newTeams(groupKids) {
    for (i=0; i<teammates.length; i+=2) {
      purpleMonkeys.push(groupKids[i]);
    }
    for (i=1; i<teammates.length; i+=2) {
      blueBarracudas.push(groupKids[i]);
    }
    document.getElementById("q10a").innerHTML="The Purple Monkeys consist of "+purpleMonkeys+".";
    document.getElementById("q10b").innerHTML="The Blue Barracudas consist of "+blueBarracudas+".";
}
newTeams(teammates);
...
function userDigits(userNum) {
  var seperate=userNum.split("");
  var sum=0;
  for (i=0; i<seperate.length; i++) {
    var threes = parseInt(seperate[i]);
    sum += threes;
  }
  return "The total of those three numbers is "+sum+".";
}
document.getElementById("submit2").addEventListener("click", function() {
  document.getElementById("q11").innerHTML=userDigits(document.getElementById("numbers").value);
})
...
function piggy(quarters, dimes, nickels, pennies) {
  var piggyQuarters = (quarters*.25);
  var piggyDimes = (dimes*.1);
  var piggyNickels = (nickels*.05);
  var piggyPennies = (pennies*.01);
  var piggyTotal = (piggyQuarters+piggyDimes+piggyNickels+piggyPennies);
  return "$"+piggyTotal.toFixed(2);
};
document.getElementById("q12").innerHTML="The total ammount in your piggy bank is "+piggy(7, 12, 4, 150)+".";
...
document.getElementById("submit3").addEventListener("click", function() {
  document.getElementById("q16").innerHTML=cleanPhone(document.getElementById("userPhone").value);
})
...
function isANumber(array) {
  for(i=0; i<array.length; i++) {
    if(isNaN(array[i])) {
      document.getElementById("q17").innerHTML = array[i]+" is not a number but a string!";
    }
    else {
      document.getElementById("q17").innerHTML = array[i]+" is a number!";
    }
  }
}
isANumber(arrayOfAllTheThings);
